                ...
                <div className="row gx-0 align-items-center" style={{height: '45px'}}>
                    <div className="col-lg-8 text-center text-lg-start mb-lg-0">
                        <div className="d-flex flex-wrap">
                            ...
                            <a  className="text-muted me-0"><i className="fas fa-envelope text-primary me-2"></i>info@fabritech.com</a>
                        </div>
                    </div>
                ...
                <div className="row g-5 align-items-center">
                    <div className="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                        <div className="pb-5">
                            ...
                            <h1 className="display-4">Software Development Service</h1>
                        </div>
                        <div className="bg-light rounded p-4">
                            <p className="my-2">
                                Fabritech offers comprehensive software development services tailored to meet the unique needs of your business. 
                                Our team of skilled developers and engineers is experienced in creating high-performance, scalable software 
                                solutions, from custom web applications to mobile apps and enterprise software.
                            </p>
                            <ul>
                                <li>Custom Software Development</li>
                                <li>Web and Mobile App Development</li>
                                <li>Enterprise Solutions and System Integration</li>
                                <li>Software Maintenance and Support</li>
                                <li>Cloud-Based Solutions and API Development</li>
                            </ul>
                            <p className="my-2">
                                We follow a client-focused approach, ensuring that our solutions align with your business goals, are user-friendly, 
                                and provide seamless performance. Whether you're looking to develop a new application or enhance an existing system, 
                                we have the expertise to deliver top-quality results that drive growth and efficiency for your business.
                            </p>
                        </div>
                    </div>
                    <div className="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                        <div className="faq-img RotateMoveRight rounded">
                            <img src="img/SDev.jpg" className="img-fluid rounded w-100" style={{height: '700px'}} alt="Image" />
                        </div>
                    </div>
                </div>
            </div>
        </div>
        {/* <!-- Software Development Service End --> */}
