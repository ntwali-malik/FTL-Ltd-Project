                ...
                <div className="row g-5 align-items-center">
                    <div className="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                        <div className="pb-5">
                            ...
                            <h1 className="display-4">Canal+ & DStv Installation and Subscription Services</h1>
                        </div>
                        <div className="bg-light rounded p-4">
                            <p className="my-2">
                                Fabritech provides professional installation and subscription services for **Canal+** and **DStv**. Our experienced technicians 
                                ensure smooth and efficient installation of satellite dishes and decoders, as well as proper alignment for optimum signal reception.
                            </p>
                            <ul>
                                <li>Canal+ Satellite Dish Installation</li>
                                <li>DStv Decoder Installation and Configuration</li>
                                <li>Subscription Renewals and Upgrades</li>
                                <li>Troubleshooting and Maintenance</li>
                                <li>MultiView and ExtraView Setup</li>
                            </ul>
                            <p className="my-2">
                                Whether you're looking for a new installation or assistance with your current subscription, we ensure that you receive uninterrupted access 
                                to your favorite channels. Fabritech is your trusted partner for high-quality satellite TV services, offering reliable support for both 
                                Canal+ and DStv systems.
                            </p>
                        </div>
                    </div>
                    <div className="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                        <div className="faq-img RotateMoveRight rounded">
                            <img src="img/dstvInsta.jpg" className="img-fluid rounded w-100" style={{height: '500px'}} alt="Image" />
                        </div>
                    </div>
                </div>
            </div>
