  ...
  return (
    <div>
      ...
      <div className="container mx-auto">
        <h2 className="text-3xl font-bold text-center mb-8 py-4">Our Clients</h2>
        ...
        <div className="flex flex-col space-y-8">
          ...
          <div className="row align-items-start mb-4">
            ...
            <div className="col-md-9">
              ...
              <p style={{ textAlign: "justify" }}>
                ...
                successfully delivered a user-friendly website that effectively
                represents DICEL SECURITY's brand and services. Additionally, we
                implemented an Internal E-sign Portal, streamlining document
                signing and submission processes within the organization. The
                website and E-sign Portal provide a seamless experience for
                DICEL SECURITY's staff, enhancing efficiency and reducing
          ...
          <div className="row align-items-start mb-4">
            ...
            <div className="col-md-9">
              ...
              <p style={{ textAlign: "justify" }}>
                ...
                website enables guests to easily browse through available rooms,
                select their desired dates, and make reservations seamlessly.
                The booking system streamlines the reservation process, allowing
                CLEO LAKE KIVU HOTEL to manage bookings efficiently and provide
                a convenient experience for their valued guests.
              </p>
            </div>
          </div>
          ...
          <div className="row align-items-start mb-4">
            ...
            <div className="col-md-9">
              ...
              <p style={{ textAlign: "justify" }}>
                ...
                solution. The website we developed for TELE10 is user-friendly,
                visually appealing, and easy to navigate. It serves as an
                effective online platform for TELE10's services, programs, and
                information. The integrated payment gateway ensures a seamless
                and secure payment process for TELE10's customers, enhancing
          ...
          <div className="row align-items-start mb-4">
            ...
            <div className="col-md-9">
              ...
              <p style={{ textAlign: "justify" }}>
                ...
                clear and concise advice, enabling KC ATTORNEYS to make informed
                decisions and achieve a more robust and streamlined IT
                environment.
              </p>
            </div>
          </div>
          ...
          <div className="row align-items-start mb-4">
            ...
            <div className="col-md-9">
              ...
              <p style={{ textAlign: "justify" }}>
                ...
                and expertise to optimize their IT infrastructure. Our services
                included assessing their existing systems, identifying areas for
                improvement, and offering practical recommendations to enhance
                their overall IT capabilities. We worked closely with NETLINK's
                team to understand their specific needs and goals, providing
                tailored solutions that align with their business objectives.
                Our consultancy services aimed to streamline operations, improve
                efficiency, and ensure a secure and reliable IT environment for
                NETLINK's ongoing success.
              </p>
            </div>
          </div>
          ...
          <div className="row align-items-start mb-4">
            ...
            <div className="col-md-9">
              <h3 className="font-weight-bold">KING FAISAL HOSPITAL RWANDA</h3>
              <h6>
              ...
              <p style={{ textAlign: "justify" }}>
                ...
                solution aims to safeguard sensitive areas, prevent unauthorized
                access, and detect any potential threats in a simple and
                user-friendly manner. KING FAISAL Hospital can now operate with
                confidence, knowing that its digital security system is in place
                to protect its valuable assets and maintain a safe environment
                for everyone.
              </p>
            </div>
          </div>
          ...
          <div className="row align-items-start mb-4">
            ...
            <div className="col-md-9">
              ...
              <p style={{ textAlign: "justify" }}>
                Our company successfully provided comprehensive digital security
                solutions for MTN Rwanda's Mobile Money Office. Through robust
                and reliable measures, we safeguarded the integrity,
                confidentiality, and availability of critical data and
                transactions within the office. Our expertise ensures the
          ...
          <div className="row align-items-start mb-4">
            ...
            <div className="col-md-9">
              ...
              <p style={{ textAlign: "justify" }}>
                ...
                showcases their services, events, and achievements. It provides
                a user-friendly experience, allowing visitors to easily navigate
                and access the information they need. The integrated payment
                solution ensures a smooth and secure transaction process,
                enabling NSS to efficiently handle various payments, such as
                membership fees, event registrations, and donations.
              </p>
            </div>
          </div>
        </div>
