                ...
                <div className="row g-5 align-items-center">
                    <div className="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                        <div className="pb-5">
                            ...
                            <h1 className="display-4">Digital Security Solutions</h1>
                        </div>
                        <div className="bg-light rounded p-4">
                            <p className="my-2">
                                At Fabritech, we provide comprehensive digital security solutions designed to safeguard your digital assets, business, and home. 
                                Our professional team offers a range of cutting-edge security services to protect your sensitive data, prevent unauthorized access, 
                                and monitor potential threats in real time. Our digital security services include:
                            </p>
                            <ul>
                                <li>CCTV camera Installation</li>
                                <li>Access Control and Time Attendance</li>
                                <li>Security audits and risk assessments</li>
                                <li>Maintenance and support for all security systems</li>
                            </ul>
                            <p className="my-2">
                                We ensure that our security solutions are tailored to your unique needs, whether it's for your business, personal devices, or residential systems. 
                                Our team stays up to date with the latest security technologies and trends to provide you with the best possible protection. 
                                Get in touch with us to discuss how we can help secure your digital environment.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                        <div className="faq-img RotateMoveRight rounded">
                            <img src="img/bio.jpg" className="img-fluid rounded w-100" style={{height: '500px'}} alt="Image" />
                        </div>
                    </div>
                </div>
            </div>
        </div>
        {/* <!-- Digital Security End --> */}
